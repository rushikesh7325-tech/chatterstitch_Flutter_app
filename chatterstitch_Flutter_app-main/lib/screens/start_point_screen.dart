              ...
              child: Column(
                children: [
                  ...
                  _buildStartCard(
                    ...
                    iconPath:
                        'assets/images/icon_book.png', // Replace with your book icon
                  ...
                  _buildStartCard(
                    ...
                    title: "Find my level",
                    subtitle:
                        "Let chatter recommend where you should start learning",
                    iconPath:
                        'assets/images/icon_compass.png', // Replace with your compass icon
              ...
              onPressed: selectedIndex == null
                  ...
                  : () {
                      if (selectedIndex == 0) {
                        ...
                        // Go to the Final Score screen to show them their base 10 points
                        Navigator.pushNamed(
                          context,
                          '/final_score',
                          arguments: widget.languageId,
                        );
                      } else {
                        // USER WANTS A TEST:
                        // Go to the quiz/placement screen
                        Navigator.pushNamed(
                          context,
                          '/placement_test',
                          arguments: widget.languageId,
            ...
            Container(
              ...
              child: Image.asset(
                ...
                errorBuilder: (context, error, stackTrace) =>
                    Icon(iconData, size: 40, color: Colors.blueGrey),
              ),
            ),
