...
import 'routine_intro_screen.dart';
...
class _LearningReasonScreenState extends State<LearningReasonScreen> {
  ...
  Widget build(BuildContext context) {
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _buildSpeechBubble(
                          "Why are you learning ${widget.languageName}?",
                        ),
                      ),
                    ],
                  ),
    ...
    ? null
    : () {
        // Convert the indices into a list of actual reason strings
        final selectedReasonTexts = selectedIndices
            .map((index) => reasons[index]['text'] as String)
            .toList();

        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => RoutineIntroScreen(
              languageId: widget.languageId,
              languageName: widget.languageName,
              proficiencyLevel: widget.proficiencyLevel,
              learningReasons: selectedReasonTexts, // Pass the reasons here!
            ),
          ),
        );
      },
