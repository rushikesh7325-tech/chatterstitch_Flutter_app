...
import 'start_point_screen.dart';
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(child: _buildSpeechBubble(speechText)),
                    ],
                  ),
          ...
          Padding(
            ...
            child: CustomButton(
              ...
              onPressed: selectedIndex == null
                  ? null
                  : () async {
                      // 1. Show a loading dialog so the user waits for the API
                      showDialog(
                        context: context,
                      ...
                      try {
                        // 2. Call your newly created Service
                        await OnboardingApiService.saveOnboardingData(
                          languageId: widget.languageId,
                          proficiencyLevel: widget.proficiencyLevel,
                          learningReasons: widget.learningReasons,
                          dailyGoal: widget.dailyGoal,
                          isPremium: selectedIndex == 0,
                        );
                        ...
                        // 4. Navigate to the Start Point Screen on success
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => StartPointScreen(
                        ...
                        // 5. Remove loading dialog and show error
                        if (!mounted) return;
                        Navigator.pop(context);
